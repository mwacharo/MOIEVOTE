    ...
    <div class="projects-section">
      ...
      <div class="projects-section-line">
        <div class="projects-status">
          ...
          <div class="item-status">
            <span class="status-number">{{$registerd_voters}}</span>
      ...
      <div class="project-boxes jsGridView">
        ...
        <div class="box-progress-wrapper">
          ...
          <p class="box-progress-percentage">{{$presidents_cast}}/ {{$registerd_voters}}</p>
        </div>
    ...
    <div class="project-box-wrapper">
      <div class="project-box" style="background-color: #e9e7fd;">
        ...
        <div class="box-progress-wrapper">
          ...
          <p class="box-progress-percentage">{{$secretary_cast}}/{{$registerd_voters}}</p>
        </div>
        <div class="project-box-footer">
          <div class="participants">
    ...
    <div class="project-box-wrapper">
      <div class="project-box">
        ...
        <div class="project-box-content-header">
          ...
          <p class="box-content-subheader">{{$tresury}}<br><span>Candidates</span></p>
        </div>
        <div class="box-progress-wrapper">
          <p class="box-progress-header">Votes Cast</p>
          <div class="box-progress-bar">
          ...
          <p class="box-progress-percentage"> {{$tresury_cast}} /{{$registerd_voters}}</p>
        </div>
        <div class="project-box-footer">
          <div class="participants">
    ...
    <div class="project-box-wrapper">
      <div class="project-box" style="background-color: #ffd3e2;">
        ...
        <div class="box-progress-wrapper">
          ...
          <p class="box-progress-percentage">{{$entertainment_cast}}/{{$registerd_voters}}</p>
        </div>
        <div class="project-box-footer">
          <div class="participants">
